function [ L, EGlob, CClosed, ELocClosed, COpen, ELocOpen, Dist] = graphProperties( varargin )
...
for i = 1:n
    ...
    GGG = digraph(MClosed{i});
    DSGClosed= distances(GGG);
     %= graphallshortestpaths(MClosed{i});
     GGA = digraph(MOpen{i});
    DSGOpen= distances(GGA);
